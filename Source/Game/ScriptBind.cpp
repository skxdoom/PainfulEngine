...
void ScriptEngine::Bind(LuaHost& host) {
    ...
    const struct {
        ...
        {"SOUND", "StreamLoad", L_SOUND_StreamLoad},
        {"SOUND", "StreamPlay", L_SOUND_StreamPlay},
        {"SOUND", "StreamPause", L_SOUND_StreamPause},
        {"SOUND", "StreamResume", L_SOUND_StreamResume},
        {"SOUND", "StreamDelete", L_SOUND_StreamDelete},
        {"SOUND", "StreamSetVolume", L_SOUND_StreamSetVolume},
        {"SOUND", "StreamGetVolume", L_SOUND_StreamGetVolume},
        {"SOUND", "StreamSetLowPass", L_SOUND_StreamSetLowPass},
        {"SOUND", "StreamGetLowPass", L_SOUND_StreamGetLowPass},
        {"SOUND", "Set3DSoundFalloff", L_SOUND_Set3DSoundFalloff},
        {"SOUND", "Get3DSoundFalloff", L_SOUND_Get3DSoundFalloff},
        ...
        {"PHYSICS", "GetHavokBodyPosition", L_PHYSICS_GetHavokBodyPosition},
        {"PHYSICS", "SetHavokBodyPosition", L_PHYSICS_SetHavokBodyPosition},
        {"PHYSICS", "PinHavokBody", L_PHYSICS_PinHavokBody},
        ...
        {"ENTITY", "EnableCollisionsToRagdoll", L_ENTITY_EnableCollisionsToRagdoll},
        {"ENTITY", "PO_LineTrace", L_ENTITY_PO_LineTrace},
        {"ENTITY", "SpawnDecal", L_ENTITY_SpawnDecal},
        {"ENTITY", "SpawnOrientedDecal", L_ENTITY_SpawnOrientedDecal},
        {"ENTITY", "SpawnStaticDecal", L_ENTITY_SpawnStaticDecal},
        {"ENTITY", "UpdateDecal", L_ENTITY_UpdateDecal},
        {"ENTITY", "ReloadDecalSystem", L_ENTITY_ReloadDecalSystem},
        {"R3D", "KeepDecals", L_R3D_KeepDecals},
        ...
        {"WORLD", "BloomFXParams", L_WORLD_BloomFXParams},
        ...
        {"R3D", "EnableBloom", L_R3D_EnableBloom},
