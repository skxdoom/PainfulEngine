...
const EngineConfig::Known kKnown[] = {
	...
	{"RendererType", "0", false, "model shading: 0 the original, 1 ambient traced through a distance field of the world about the camera"},
	...
	{"SdfSkyGain", "100", false, "type 1: percent of the sky's light a ray that reaches it takes"},
	{"SdfSkyHighlight", "0", false, "type 1: percent the brightest sky, the clipped sun, is lifted by at white"},
	{"SdfDebugGrid", "false", true, "a lattice of probes lit by the distance field about the camera, under either type"},
	{"SdfDebugClipmaps", "false", true, "the distance field's surfaces raymarched over the frame, as the traces see them"},
