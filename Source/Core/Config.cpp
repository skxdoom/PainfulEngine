...
const EngineConfig::Known kKnown[] = {
	...
	{"RendererType", "0", false, "model shading: 0 the original, 1 ambient from probes traced on the GPU through a distance field of the world about the camera"},
	...
	{"SdfDebugGrid", "false", true, "a lattice of spheres shaded from the probe grids about the camera, under either type"},
	{"SdfDebugClipmaps", "false", true, "the distance field raymarched over the frame, as the probe rays see it"},
