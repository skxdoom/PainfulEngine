...
const EngineConfig::Known kKnown[] = {
	...
	{"ModelLightScale", "100", false, "type 1:percent of the lights' strength on a model"},
	{"RendererType", "0", false, "model shading: 0 the original, 1 light traced at every model vertex through a distance field of the level"},
	{"SdfGain", "100", false, "type 1:percent of the traced light a model takes"},
	{"SdfSheen", "100", false, "type 1: percent of the world's light a model reflects, by fresnel toward its rim"},
	{"SdfSheenF0", "4", false, "type 1: percent of that reflection kept where a surface faces the eye; the rim keeps all"},
	{"SdfAlbedo", "0", false, "type 1:percent of a surface's albedo in the field's light; 0 the light arriving, 100 the light leaving"},
	{"SdfFieldMB", "256", false, "type 1: megabytes the distance field's textures may take, estimated; its voxels are the finest that fit"},
	{"SdfSkyGain", "100", false, "type 1:percent of the sky's light, 100 being what the level's lightmaps say the open sky gives"},
	{"SdfSkyHighlight", "0", false, "type 1:percent the brightest sky, the clipped sun, is lifted by at white"},
	{"SdfFogGain", "100", false, "type 1:percent of the level fog's colour a probe ray gathers over its length"},
