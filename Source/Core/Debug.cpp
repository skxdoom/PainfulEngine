...
Row g_rows[] = {
	...
	{"PAINFUL_AMBIENTVIEW", Kind::kFlag, "models drawn as their ambient term alone (traced under Pf.RendererType 1)"},
	{"PAINFUL_SDF_CHURN", Kind::kFlag, "rebuild the distance field cascades nonstop, to time a rebuild without moving"},
