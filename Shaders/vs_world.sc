...
$output v_texcoord0, v_texcoord1, v_normal, v_viewdist, v_wpos
...
// The exception is the dynamic lights - a torch, a flash, the flashlight - and
// those need the world position the fragment shader measures them from.
