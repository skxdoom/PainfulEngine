...
#
# Reads the recovered Lua API listing - Engine_LuaAPI.md, kept with the RE
# material outside this repository - and
...
[void]$sb.AppendLine('// Source: the recovered Lua API listing (941 natives recovered from Engine.dll),')
