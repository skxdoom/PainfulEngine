...
([`Physics.md`](Reference/Physics.md), "Gibs"). Open under it: the rest of
this list:
...
| Streams | LANDED — `SOUND.StreamLoad` / `StreamPlay` / `StreamPause` / `StreamSetVolume`, the ambient/battle music ([`Sound.md`](Reference/Sound.md), "Music streams"). Left: the stream low-pass. |
